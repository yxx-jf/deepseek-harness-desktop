...
The app uses the [deepseek-whale-girl-icon-main](https://github.com/yxx-jf/deepseek-whale-girl-icon-main) icon set. The master source is `improved-1.png` (984×984, RGBA), which is scaled to the required sizes for each platform:
...
| `resources/trayTemplate.png` | Scaled from `improved-1.png` (32×32) | tray |
| `resources/tray.png` | Scaled from `improved-1.png` (32×32) | tray |

To refresh, regenerate the PNGs from the master and re-assemble `icon.ico` and `icon.icns`.
